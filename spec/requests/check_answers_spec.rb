...
RSpec.describe 'CheckAnswers', type: :request do
  describe 'POST /create' do
    ...
    describe 'POST /question_categories/:question_category_id/questions/:question_id/check_answers' do
      before { sign_in user }

      it '正解のとき、is_correct=trueと解答、解説、メモを返すこと' do
        post question_category_question_check_answers_path(question_category, question), params: { choice_ids: [choice1_true.id, choice3_true.id] }, as: :json
      ...
      it '不正解のとき、is_correct=falseと解答、解説、メモを返すこと' do
        post question_category_question_check_answers_path(question_category, question), params: { choice_ids: [choice2_false.id, choice3_true.id] }, as: :json
