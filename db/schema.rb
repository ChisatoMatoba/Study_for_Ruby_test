...
ActiveRecord::Schema[7.1].define(version: 2025_06_02_125059) do
  ...
  create_table "memos", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["user_id", "question_id"], name: "index_memos_on_user_question", unique: true
  ...
  create_table "questions", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["question_category_id", "number"], name: "index_questions_on_question_category_id_and_number", unique: true
